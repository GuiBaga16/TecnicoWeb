...
require_once __DIR__ . '/controller/RefriController.php';

$controller = new RefrigeranteController();

// Rotas com ID: /refrigerantes/42
if (preg_match('#^/refrigerantes/(\d+)$#', $uri, $match)) {
    $id = (int) $match[1];
...
// Rotas sem ID: /refrigerantes
if ($uri === '/refrigerantes') {
    switch ($method) {
        case 'GET':
